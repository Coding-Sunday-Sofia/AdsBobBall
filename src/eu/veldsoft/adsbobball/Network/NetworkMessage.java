...
public class NetworkMessage {
	...
	/*
	 * construct a new NetworkMessage from a byte buffer that contains the data
	 * of exactly one NetworkMessage
	 */
	...
	/*
	 * construct a new NetworkMessage from a Stream reading exactly the required
	 * amount of bytes
	 */
