...
public class BarSection implements Parcelable {
	...
	public BarSection(final float x1, final float y1, final float x2,
			final float y2, final int direction, final float speed) {
	...
	public static final Parcelable.Creator<BarSection> CREATOR = new Parcelable.Creator<BarSection>() {
