...
import static eu.veldsoft.adsbobball.GameLogic.BarDirection.fromTouchDirection;
...
public class GameEventStartBar extends GameEvent {
	...
	public void apply(GameState gs) {
		...
		if (!bar.isActive() && player.getLives() > 0)
			bar.start(fromTouchDirection(dir), gs.getGrid()
					.getGridSquareFrameContainingPoint(origin));
	}
	...
	public String toString() {
		return getClass().getName() + " t=" + getTime() + " playerId="
				+ playerId + " origin=" + origin;
	}
}
